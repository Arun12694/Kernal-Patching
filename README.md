...
1> Take Aprovals from Stake Holders	                                       - Infra-Team
2> Take Back-up of server before Patching	                               - Infra-Team
3> Take App/DB backup if any	                                           - App/DB Team
4> Take Pre-patch report of respective servers	                           - Infra-Team
...
# uname -r  //to check existing kernal package name before reboot
# rpm -qa --last | grep kernel
# mount -a
# reboot -f   // to validate all the install updates
# uname -r   // to check updated kernel version is installed or not
# df -hTP    //to check mount points
